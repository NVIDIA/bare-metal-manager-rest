...
// ResolveRef resolves a $ref pointer like "#/components/schemas/SiteCreateRequest"
// and returns the referenced schema.
...
// ResolveSchema follows $ref if present, otherwise returns the schema itself.
...
// RequestBodySchema returns the resolved JSON schema for an operation's request body.
