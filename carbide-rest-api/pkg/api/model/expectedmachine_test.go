...
func TestAPIExpectedMachineCreateRequest_Validate(t *testing.T) {
	tests := []struct {
		...
		{
			desc: "error when BmcMacAddress is wrong length (too long)",
			obj: APIExpectedMachineCreateRequest{

				BmcMacAddress:       "00:11:22:33:44:55:66",
				DefaultBmcUsername:  cdb.GetStrPtr("admin"),
				DefaultBmcPassword:  cdb.GetStrPtr("password"),
				ChassisSerialNumber: "CHASSIS123",
			},
		...
		{
			desc: "error when BmcUsername is too long",
			obj: APIExpectedMachineCreateRequest{

				BmcMacAddress:       "00:11:22:33:44:55",
				DefaultBmcUsername:  cdb.GetStrPtr("verylongusernamethatexceedslimit"),
				DefaultBmcPassword:  cdb.GetStrPtr("password"),
				ChassisSerialNumber: "CHASSIS123",
			},
			expectErr: true,
		...
		{
			desc: "error when BmcPassword is too long",
			obj: APIExpectedMachineCreateRequest{

				BmcMacAddress:       "00:11:22:33:44:55",
				DefaultBmcUsername:  cdb.GetStrPtr("admin"),
				DefaultBmcPassword:  cdb.GetStrPtr("verylongpasswordthatexceedslimitverylongpasswordthatexceedslimit"),
				ChassisSerialNumber: "CHASSIS123",
			},
			expectErr: true,
		},
		...
		{
			desc: "error when ChassisSerialNumber is too long",
			obj: APIExpectedMachineCreateRequest{

				BmcMacAddress:       "00:11:22:33:44:55",
				DefaultBmcUsername:  cdb.GetStrPtr("admin"),
				DefaultBmcPassword:  cdb.GetStrPtr("password"),
				ChassisSerialNumber: "verylongchassisserialnumberthatexceedslimitverylongchassisserialnumberthatexceedslimitverylongchassisserialnumberthatexceedslimit",
			},
			expectErr: true,
		},
		{
			...
			obj: APIExpectedMachineCreateRequest{
				BmcMacAddress:            "00:11:22:33:44:55",
				DefaultBmcUsername:       cdb.GetStrPtr(""),
				DefaultBmcPassword:       cdb.GetStrPtr(""),
				ChassisSerialNumber:      "CHASSIS123",
...
func TestAPIExpectedMachineUpdateRequest_Validate(t *testing.T) {
	chassisSerial := "CHASSIS123"
	emptySerial := ""
	longSerial := "verylongchassisserialnumberthatexceedslimitverylongchassisserialnumberthatexceedslimit"
	validUsername := "admin"
	emptyUsername := ""
	longUsername := "verylongusernamethatexceedslimit"
	validPassword := "password123"
	emptyPassword := ""
	longPassword := "verylongpasswordthatexceedslimitverylongpasswordthatexceedslimit"
	...
	tests := []struct {
		...
		},
		{
			...
			obj: APIExpectedMachineUpdateRequest{
				ChassisSerialNumber: &emptySerial,
				Labels:              map[string]string{"env": "test"},
			},
			expectErr: true,
		},
		{
			desc: "error when chassis serial number is too long",
			obj: APIExpectedMachineUpdateRequest{
		...
		},
		{
			...
			obj: APIExpectedMachineUpdateRequest{
				ChassisSerialNumber: &chassisSerial,
				DefaultBmcUsername:  &emptyUsername,
				Labels:              map[string]string{"env": "test"},
			},
			expectErr: true,
		},
		{
			...
			obj: APIExpectedMachineUpdateRequest{
				ChassisSerialNumber: &chassisSerial,
				DefaultBmcPassword:  &emptyPassword,
				Labels:              map[string]string{"env": "test"},
			},
			expectErr: true,
		},
		...
		{
			desc: "error when BMC username is too long",
			obj: APIExpectedMachineUpdateRequest{
				ChassisSerialNumber: &chassisSerial,
				DefaultBmcUsername:  &longUsername,
				Labels:              map[string]string{"env": "test"},
			},
			expectErr: true,
		},
		{
			desc: "error when BMC password is too long",
			obj: APIExpectedMachineUpdateRequest{
				ChassisSerialNumber: &chassisSerial,
				DefaultBmcPassword:  &longPassword,
				Labels:              map[string]string{"env": "test"},
			},
			expectErr: true,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			validate: func(t *testing.T, apiEM *APIExpectedMachine) {
				...
				assert.Len(t, apiEM.Sku.Components.Tpm, 1)
				assert.Equal(t, "Infineon", apiEM.Sku.Components.Tpm[0].Vendor)
				assert.Equal(t, "SLB 9670", apiEM.Sku.Components.Tpm[0].Model)
				assert.Equal(t, uint32(1), apiEM.Sku.Components.Tpm[0].Count)
			},
		},
		{
