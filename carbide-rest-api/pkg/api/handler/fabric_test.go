...
func testFabricBuildSite(t *testing.T, dbSession *cdb.Session, ip *cdbm.InfrastructureProvider, name string, status *string) *cdbm.Site {
	if status == nil {
...
func TestFabricHandler_Get(t *testing.T) {
	...
	site1 := testFabricBuildSite(t, dbSession, ip1, "testSite1", nil)
	site2 := testFabricBuildSite(t, dbSession, ip2, "testSite2", nil)
