...
import (
	...
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-api/pkg/api/model/util"
	cdmu "github.com/NVIDIA/carbide-rest-api/carbide-rest-api/pkg/api/model/util"
	...
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-common/pkg/otelecho"
	...
	swe "github.com/NVIDIA/carbide-rest-api/carbide-site-workflow/pkg/error"
...
func testInstanceBuildVPC(t *testing.T, dbSession *cdb.Session, name string, ip *cdbm.InfrastructureProvider, tn *cdbm.Tenant, st *cdbm.Site, cvID *uuid.UUID, labels map[string]string, networkVTtype *string, status string, user *cdbm.User) *cdbm.Vpc {
...
func TestCreateInstanceHandler_Handle(t *testing.T) {
	...
	vpc1 := testInstanceBuildVPC(t, dbSession, "test-vpc-1", ip, tn1, st1, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc1)

	vpc2 := testInstanceBuildVPC(t, dbSession, "test-vpc-2", ip, tn1, st1, nil, nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusPending, tnu1)
	assert.NotNil(t, vpc2)

	vpcSiteNotReady := testInstanceBuildVPC(t, dbSession, "test-vpc-3", ip, tn1, stNotReady, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu1)
	...
	vpc3 := testInstanceBuildVPC(t, dbSession, "test-vpc-3", ip, tn2, st2, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu2)
	assert.NotNil(t, vpc3)

	vpc4 := testInstanceBuildVPC(t, dbSession, "test-vpc-4", ip, tn2, st2, nil, nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusPending, tnu2)
	...
	vpc5 := testInstanceBuildVPC(t, dbSession, "test-vpc-4", ip, tn3, st3, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu3)
	assert.NotNil(t, vpc5)

	vpc6 := testInstanceBuildVPC(t, dbSession, "test-vpc-5", ip, tn3, st3, nil, nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusPending, tnu3)
	...
	vpc7 := testInstanceBuildVPC(t, dbSession, "test-vpc-7", ip, tn5, st4, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu5)
	...
	vpc8 := testInstanceBuildVPC(t, dbSession, "test-vpc-8", ip, tn6, st6, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu6)
	...
	vpc10 := testInstanceBuildVPC(t, dbSession, "test-vpc-7", ip, tn7, st7, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu7)
	...
	vpc7b := testInstanceBuildVPC(t, dbSession, "test-vpc-7b", ip, tn7, st7b, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu7)
	...
	vpc11 := testInstanceBuildVPC(t, dbSession, "test-vpc-11", ip, tn8, st8, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu8)
	...
	// FNN VPC
	vpc9 := testInstanceBuildVPC(t, dbSession, "test-vpc-9", ip, tn1, st1, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcFNN), cdbm.VpcStatusReady, tnu1)
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				respMessage: "Tenant does not have capability to create instances from specific machine",
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: "Machine specified in request is not part of the site",
			},
			wantErr: false,
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: "Machine specified in request is already in use",
			},
			wantErr: false,
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: "Machine specified in request is not healthy",
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: "Machine specified in request is missing on site",
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: "OperatingSystem specified in request is not in VPC site",
			},
			wantErr: false,
		},
		{
		...
		{
			name: "os type image, should succeed",
			fields: fields{
				dbSession: dbSession,
				tc:        tc,
				cfg:       cfg,
		...
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: fmt.Sprintf("Subnet: %v specified in request data is not in Ready state", subnet2.ID.String()),
			},
			wantErr: false,
		},
		{
		...
		{
			name: "test Instance create API endpoint failed, always iPXE boot flag specified along with image based OS",
			fields: fields{
				dbSession: dbSession,
				tc:        tc,
				cfg:       cfg,
			...
			args: args{
				...
				reqUser:     tnu5,
				respCode:    http.StatusBadRequest,
				respMessage: "cannot be set with Operating System of type `Image`",
			},
			wantErr: false,
		},
		{
			name: "test Instance create API endpoint failed, custom iPXE specified along with image based OS",
			fields: fields{
				dbSession: dbSession,
				tc:        tc,
				cfg:       cfg,
			...
			args: args{
				...
				reqUser:     tnu5,
				respCode:    http.StatusBadRequest,
				respMessage: "cannot be specified with Operating System of type `Image`",
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			args: args{
				...
				reqUser:     tnu1,
				respCode:    http.StatusBadRequest,
				respMessage: "Could not find NetworkSecurityGroup with ID specified in request data",
			},
			wantErr: false,
		},
		{
...
func TestUpdateInstanceHandler_Handle(t *testing.T) {
	...
	vpc3 := testInstanceBuildVPC(t, dbSession, "test-vpc-2", ip, tn2, st2, nil, nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusPending, tnu2)
	assert.NotNil(t, vpc3)
	...
	vpc4 := testInstanceBuildVPC(t, dbSession, "test-vpc-4", ip, tn1, st1, nil, nil, cdb.GetStrPtr(cdbm.VpcFNN), cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc4)
	...
	tests := []struct {
		...
		{
			name: "test Instance update API endpoint success with OS image base change, custom user-data, phone-home disabled, update trigger with timeout",
			fields: fields{
				dbSession: dbSession,
				tc:        tc,
				scp:       scp,
		...
		{
			name: "test Instance update API endpoint failure with OS change of OS to image-based OS from wrong site",
			fields: fields{
				dbSession: dbSession,
				tc:        tc,
				scp:       scp,
		...
		{
			name: "test Instance update API endpoint success with OS change of OS to image-based OS from correct site, trigger workflow timeout",
			fields: fields{
				dbSession: dbSession,
				tc:        tc,
				scp:       scp,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.args.ethInterfacesToDelete != nil && len(tt.args.ethInterfacesToDelete) > 0 && len(tt.args.reqData.Interfaces) > 0 {
				...
				for i, _ := range ifcs {
					...
					assert.Equal(t, ifcs[i].Status, cdbm.InterfaceStatusPending)
				}
			}

			if tt.args.ibInterfaceToDelete != nil && len(tt.args.ibInterfaceToDelete) > 0 && len(tt.args.reqData.InfiniBandInterfaces) > 0 {
				...
				for i, _ := range ibifcs {
					assert.Equal(t, ibifcs[i].InfiniBandPartitionID.String(), tt.args.reqData.InfiniBandInterfaces[i].InfiniBandPartitionID)
					assert.Equal(t, ibifcs[i].Status, cdbm.InfiniBandInterfaceStatusPending)
				}
			}
...
func TestGetAllInstanceHandler_Handle(t *testing.T) {
	...
	vpc3 := testInstanceBuildVPC(t, dbSession, "test-vpc-3", ip, tn1, st1, nil, nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc3)

	vpc4 := testInstanceBuildVPC(t, dbSession, "test-vpc-4", ip, tn1, st3, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc4)
	...
	tests := []struct {
		...
		},
		{
			...
			filter: cdbm.InstanceFilterInput{
				Name: cdb.GetStrPtr("test-instance-vpc"),
			},
			wantErr:                   false,
			expectedCount:             1,
			expectedTotal:             1,
...
func TestDeleteInstanceHandler_Handle(t *testing.T) {
	...
	vpc3 := testInstanceBuildVPC(t, dbSession, "test-vpc-3", ip, tn1, stNotReady, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc3)
