...
func testVPCBuildSite(t *testing.T, dbSession *cdb.Session, ip *cdbm.InfrastructureProvider, name string, isNativeNetworkingEnabled bool, status string, user *cdbm.User) *cdbm.Site {
	...
	st, err := stDAO.Create(context.Background(), nil, cdbm.SiteCreateInput{
		...
		Config:                        cdbm.SiteConfig{NativeNetworking: isNativeNetworkingEnabled},
...
func testVPCBuildVPC(t *testing.T, dbSession *cdb.Session, name string, ip *cdbm.InfrastructureProvider, tn *cdbm.Tenant, st *cdbm.Site, nvt *string, labels map[string]string, status string, user *cdbm.User) *cdbm.Vpc {
...
func TestCreateVPCHandler_Handle(t *testing.T) {
	...
	st1 := testVPCBuildSite(t, dbSession, ip, "test-site-1", true, cdbm.SiteStatusRegistered, ipu)
	assert.NotNil(t, st1)

	st2 := testVPCBuildSite(t, dbSession, ip, "test-site-2", true, cdbm.SiteStatusRegistered, ipu)
	assert.NotNil(t, st2)

	st3 := testVPCBuildSite(t, dbSession, ip, "test-site-3", false, cdbm.SiteStatusRegistered, ipu)
	assert.NotNil(t, st3)
...
func TestUpdateVPCHandler_Handle(t *testing.T) {
	...
	st := testVPCBuildSite(t, dbSession, ip, "test-site-1", false, cdbm.SiteStatusRegistered, ipu)
	assert.NotNil(t, st)

	// Site with no allocations
	st2 := testVPCBuildSite(t, dbSession, ip, "test-site-2", false, cdbm.SiteStatusRegistered, ipu)
	assert.NotNil(t, st2)
	...
	vpc := testVPCBuildVPC(t, dbSession, "test-vpc", ip, tn, st, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "west1"}, cdbm.VpcStatusReady, tnu)
	assert.NotNil(t, vpc)

	vpc2 := testVPCBuildVPC(t, dbSession, "test-vpc-2", ip, tn, st, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "wes2"}, cdbm.VpcStatusReady, tnu)
	assert.NotNil(t, vpc2)

	vpc3 := testVPCBuildVPC(t, dbSession, "test-vpc-3", ip, tn, st2, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "west3"}, cdbm.VpcStatusReady, tnu)
	assert.NotNil(t, vpc2)

	vpc4 := testVPCBuildVPC(t, dbSession, "test-vpc-3", ip, tn, st3, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "west6"}, cdbm.VpcStatusReady, tnu)
...
func TestUpdateVirtualizationVPCHandler_Handle(t *testing.T) {
	...
	vpc4 := testVPCBuildVPC(t, dbSession, "test-vpc-3", ip, tn, st2, cdb.GetStrPtr(cdbm.VpcFNN), map[string]string{"zone": "west6"}, cdbm.VpcStatusReady, tnu)
	assert.NotNil(t, vpc4)
...
func TestGetVPCHandler_Handle(t *testing.T) {
	...
	vpc := testVPCBuildVPC(t, dbSession, "test-vpc", ip, tn1, st, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "west1"}, cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc)
...
func TestGetAllVPCHandler_Handle(t *testing.T) {
	...
	for i := 0; i < totalCount; i++ {
		...
		vpc := testVPCBuildVPC(t, dbSession, fmt.Sprintf("test-vpc-%02d", i), ip, tn, curSite, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "test-vpc-%02d"}, cdbm.VpcStatusPending, tnu)
		assert.NotNil(t, vpc)
...
func TestDeleteVPCHandler_Handle(t *testing.T) {
	...
	vpc1 := testVPCBuildVPC(t, dbSession, "test-vpc-1", ip, tn1, st, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "east1"}, cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc1)

	vpc2 := testVPCBuildVPC(t, dbSession, "test-vpc-2", ip, tn1, st, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), map[string]string{"zone": "east1"}, cdbm.VpcStatusReady, tnu1)
	assert.NotNil(t, vpc2)

	vpc3 := testVPCBuildVPC(t, dbSession, "test-vpc-3", ip, tn1, st, cdb.GetStrPtr(cdbm.VpcFNN), map[string]string{"zone": "east1"}, cdbm.VpcStatusReady, tnu1)
