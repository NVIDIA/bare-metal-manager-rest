...
func (csh CreateSubnetHandler) Handle(c echo.Context) error {
	...
	var subnetDomainID *cwssaws.UUID = nil
	if subnet.DomainID != nil {
		subnetDomainID = &cwssaws.UUID{Value: subnet.DomainID.String()}
	}
	...
	createSubnetRequest := &cwssaws.NetworkSegmentCreationRequest{
		Id:          &cwssaws.UUID{Value: common.GetSiteNetworkSegmentID(subnet).String()},
		Name:        subnet.Name,
