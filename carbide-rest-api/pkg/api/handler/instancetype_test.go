...
func TestGetAllInstanceTypeHandler_Handle(t *testing.T) {
	...
	vpc1 := testInstanceBuildVPC(t, dbSession, "test-vpc-1", ip, tn1, st, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu1)
	...
	vpc2 := testInstanceBuildVPC(t, dbSession, "test-vpc-1", ip, tn2, st, cdb.GetUUIDPtr(uuid.New()), nil, cdb.GetStrPtr(cdbm.VpcEthernetVirtualizer), cdbm.VpcStatusReady, tnu2)
