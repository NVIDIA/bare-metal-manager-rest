...
func TestMachineCapabilitySQLDAO_GetAll(t *testing.T) {
	...
	mcd.Create(ctx, nil, MachineCapabilityCreateInput{InstanceTypeID: &it.ID, Type: MachineCapabilityTypeCPU, Name: "Test Capability", Frequency: db.GetStrPtr("3 GHz"), Count: db.GetIntPtr(1)})
