...
import (
	...
	computils "github.com/NVIDIA/carbide-rest-api/carbide-site-agent/pkg/components/common"

	"github.com/NVIDIA/carbide-rest-api/carbide-site-agent/pkg/components/utils"

	wflows "github.com/NVIDIA/carbide-rest-api/carbide-rest-api-schema/schema/site-agent/workflows/v1"
	workflowtypes "github.com/NVIDIA/carbide-rest-api/carbide-site-agent/pkg/datatypes/managertypes/workflow"
...
// TODO(deprecated): Remove any related VpcDelete references after cloud-api and agent are updated everywhere.  We've moved to sync workflow.
...
Site Controller:
 process(R1)
  process(R2)
   ...
   Summary:
   1. Handling Temporal failure after cloud api persists the user Request
   ...
   4. All update Requests will be sepearate row in the status table
	  This status timestamp is the one that will be sent from cloud api - worker -> site agent
*/
