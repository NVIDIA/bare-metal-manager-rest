...
import (
	...
	sitemgr "github.com/NVIDIA/carbide-rest-api/carbide-rest-site-manager/pkg/sitemgr"
...
func Test_Bootstrap(t *testing.T) {
	t.Skip("Skipping test that requires full Elektra environment with DB_SERVER and other configs")
	TestInitElektra(t)
