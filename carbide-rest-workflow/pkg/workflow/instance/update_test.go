...
func (s *UpdateInstanceTestSuite) Test_UpdateInstanceInventory_Success() {
	...
	// Mock RecordInstanceLifecycleMetrics activity
	s.env.RegisterActivity(instanceManager.RecordInstanceLifecycleMetrics)
	s.env.OnActivity(instanceManager.RecordInstanceLifecycleMetrics, mock.Anything, siteID, mock.Anything).Return(nil)
