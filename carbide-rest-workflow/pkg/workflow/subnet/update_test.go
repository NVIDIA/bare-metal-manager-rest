...
func (s *UpdateSubnetTestSuite) Test_UpdateSubnetInventory_Success() {
	...
	// Mock RecordSubnetLifecycleMetrics activity
	s.env.RegisterActivity(subnetManager.RecordSubnetLifecycleMetrics)
	s.env.OnActivity(subnetManager.RecordSubnetLifecycleMetrics, mock.Anything, siteID, mock.Anything).Return(nil)
