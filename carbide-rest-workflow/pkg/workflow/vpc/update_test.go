...
func (s *UpdateVpcTestSuite) Test_UpdateVpcInventory_Success() {
	...
	// Mock RecordVpcOperationMetrics activity
	s.env.RegisterActivity(vpcManager.RecordVpcLifecycleMetrics)
	s.env.OnActivity(vpcManager.RecordVpcLifecycleMetrics, mock.Anything, siteID, mock.Anything).Return(nil)
