...
func TestManageVpcPrefix_UpdateVpcPrefixesInDB(t *testing.T) {
	...
	for i := 0; i < 34; i++ {
		ctrlVpcPrefix := &cwssaws.VpcPrefix{
			Id:   &cwssaws.UUID{Value: pagedVpcPrefixes[i].ID.String()},
		...
		},
		{
			...
			args: args{
				...
				vpcPrefixInventory: &cwssaws.VpcPrefixInventory{
					VpcPrefixes: []*cwssaws.VpcPrefix{
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix1.ID.String()},
							Name: vpcPrefix1.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix2.ID.String()},
							Name: vpcPrefix2.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix3.ID.String()},
							Name: vpcPrefix3.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix4.ID.String()},
							Name: vpcPrefix4.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix8.ID.String()},
							Name: vpcPrefix8.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix9.ID.String()},
							Name: vpcPrefix9.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpcPrefix10.ID.String()},
