...
func TestManageVpc_CreateVpcViaSiteAgent(t *testing.T) {
	t.Skip("Skipping test that requires config.NewConfig() with TEMPORAL_SERVER_NAME")
	type fields struct {
...
func TestManageVpc_UpdateVpcsInDB(t *testing.T) {
	...
	for i := 0; i < 34; i++ {
		ctrlVpc := &cwssaws.Vpc{
			Id:   &cwssaws.UUID{Value: pagedVpcs[i].ControllerVpcID.String()},
		...
		},
		{
			...
			args: args{
				...
				vpcInventory: &cwssaws.VPCInventory{
					...
					Vpcs: []*cwssaws.Vpc{
						{
							Id:                        &cwssaws.UUID{Value: vpc1.ID.String()},
							Name:                      vpc1.ID.String(),
							NetworkVirtualizationType: &nwvt,
						},
						{
							Id:   &cwssaws.UUID{Value: vpc2.ControllerVpcID.String()},
							Name: vpc2.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpc3.ControllerVpcID.String()},
							Name: vpc3.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpc4.ControllerVpcID.String()},
							Name: vpc4.ID.String(),
						},
						{
							Id:   &cwssaws.UUID{Value: vpc8.ControllerVpcID.String()},
							Name: vpc8.ID.String(),
						},
						{
						...
						{
							Id:                        &cwssaws.UUID{Value: vpc12.ControllerVpcID.String()},
							Name:                      vpc12.ID.String(),
							NetworkVirtualizationType: &evt,
						},
						{
							Id:                        &cwssaws.UUID{Value: vpc13.ControllerVpcID.String()},
...
func Test_VpcMetrics_Delete_DeletingOnly(t *testing.T) {
	...
	util.TestAssertMetricExistsTimes(t, reg, "cloud_workflow_vpc_operation_duration_seconds", 1, map[string]string{
...
func Test_VpcMetrics_Delete_NoDeleting(t *testing.T) {
	...
	util.TestAssertMetricExistsTimes(t, reg, "cloud_workflow_vpc_operation_duration_seconds", 0, nil, 0)
}
