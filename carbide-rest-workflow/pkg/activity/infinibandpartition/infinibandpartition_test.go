...
func TestManageInfiniBandPartition_UpdateInfiniBandPartitionsInDB(t *testing.T) {
	...
	for i := 0; i < 34; i++ {
		ctrlIbp := &cwssaws.IBPartition{
			Id: &cwssaws.UUID{Value: pagedIbps[i].ControllerIBPartitionID.String()},
			Config: &cwssaws.IBPartitionConfig{
		...
		},
		{
			...
			args: args{
				...
				infiniBandPartitionInventory: &cwssaws.InfiniBandPartitionInventory{
					IbPartitions: []*cwssaws.IBPartition{
						{
							Id: &cwssaws.UUID{Value: ibp1.ID.String()},
							Config: &cwssaws.IBPartitionConfig{
								Name: ibp1.ID.String(),
							},
						...
						{
							Id: &cwssaws.UUID{Value: ibp2.ID.String()},
							Config: &cwssaws.IBPartitionConfig{
								Name: ibp2.ID.String(),
							},
						},
						{
							Id: &cwssaws.UUID{Value: ibp3.ID.String()},
							Config: &cwssaws.IBPartitionConfig{
								Name: ibp3.ID.String(),
							},
						},
						{
							Id: &cwssaws.UUID{Value: ibp4.ControllerIBPartitionID.String()},
							Config: &cwssaws.IBPartitionConfig{
								Name: ibp4.ID.String(),
							},
						},
						{
							Id: &cwssaws.UUID{Value: ibp8.ControllerIBPartitionID.String()},
							Config: &cwssaws.IBPartitionConfig{
								Name: ibp8.ID.String(),
							},
							Status: &cwssaws.IBPartitionStatus{
