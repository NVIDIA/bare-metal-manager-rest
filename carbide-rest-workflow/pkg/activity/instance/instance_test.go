...
import (
	...
	sc "github.com/NVIDIA/carbide-rest-api/carbide-rest-workflow/pkg/client/site"
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-workflow/pkg/queue"
	cwu "github.com/NVIDIA/carbide-rest-api/carbide-rest-workflow/pkg/util"
	...
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-workflow/pkg/util"

	cwsv1 "github.com/NVIDIA/carbide-rest-api/carbide-rest-api-schema/schema/site-agent/workflows/v1"
...
func TestManageInstance_CreateInstanceViaSiteAgent(t *testing.T) {
	...
	// Build Interfaces
	ifc := util.TestBuildInterface(t, dbSession, &instance.ID, &subnet.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifc)
	ifc2 := util.TestBuildInterface(t, dbSession, &instance3.ID, &subnet2.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifc2)
	ifc3 := util.TestBuildInterface(t, dbSession, &instance4.ID, &subnet3.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifc3)
	ifc4 := util.TestBuildInterface(t, dbSession, &instance.ID, &subnet4.ID, nil, false, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifc4)
	ifc5 := util.TestBuildInterface(t, dbSession, &instance5.ID, &subnet.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	ifc21 := util.TestBuildInterface(t, dbSession, &instance21.ID, &subnet21.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
...
func TestManageInstance_UpdateInstanceInDB(t *testing.T) {
	...
	deletingInterface := util.TestBuildInterface(t, dbSession, &deletingInstance.ID, &subnet.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusReady)
	...
	ifcvpc := util.TestBuildInterface(t, dbSession, &instance1.ID, nil, &vpcPrefix1.ID, true, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	instInfo2 := cwsv1.InstanceInfo{
		Status:       cwsv1.WorkflowStatus_WORKFLOW_STATUS_SUCCESS,
		StatusMsg:    "Instance was successfully created",
		Instance:     &cwsv1.Instance{Id: &cwsv1.UUID{Value: "bad-uuid"}},
		ObjectStatus: cwsv1.ObjectStatus_OBJECT_STATUS_CREATED,
	}
	instInfo3 := cwsv1.InstanceInfo{
		...
		Instance: &cwsv1.Instance{
			Id: &cwsv1.UUID{Value: controllerInstanceID},
	...
	instInfo5 := cwsv1.InstanceInfo{
		...
		Instance:     &cwsv1.Instance{Id: &cwsv1.UUID{Value: controllerInstanceID}},
	...
	instInfo7 := cwsv1.InstanceInfo{
		...
		StatusMsg: "Instance was successfully created",
		Instance: &cwsv1.Instance{
			Id: &cwsv1.UUID{Value: instance1.ControllerInstanceID.String()},
			Config: &cwsv1.InstanceConfig{
				Network: &cwsv1.InstanceNetworkConfig{
					Interfaces: []*cwsv1.InstanceInterfaceConfig{
						{
							...
							NetworkDetails: &cwsv1.InstanceInterfaceConfig_VpcPrefixId{
								VpcPrefixId: &cwsv1.UUID{Value: vpcPrefix1.ID.String()},
							},
						},
					},
				},
...
func TestManageInstance_UpdateInstancesInDB(t *testing.T) {
	...
	interface1 := util.TestBuildInterface(t, dbSession, &instance1.ID, &subnet1.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, interface1)
	interface2 := util.TestBuildInterface(t, dbSession, &instance1.ID, &subnet2.ID, nil, false, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, interface2)
	interface3 := util.TestBuildInterface(t, dbSession, &instance1.ID, &subnet3.ID, nil, false, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	instance2Subnet := util.TestBuildInterface(t, dbSession, &instance2.ID, &subnet1.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	instance3Subnet := util.TestBuildInterface(t, dbSession, &instance3.ID, &subnet1.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	instance4Subnet := util.TestBuildInterface(t, dbSession, &instance4.ID, &subnet1.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusError)
	...
	ifcvpc := util.TestBuildInterface(t, dbSession, &instance11.ID, nil, &vpcPrefix1.ID, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifcvpc)
	...
	ifcvpc_deleting := util.TestBuildInterface(t, dbSession, &instance15.ID, nil, &vpcPrefix1.ID, true, &tnu.ID, cdbm.InterfaceStatusDeleting)
	assert.NotNil(t, ifcvpc_deleting)

	ifcvpc_pending := util.TestBuildInterface(t, dbSession, &instance15.ID, nil, &vpcPrefix2.ID, true, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	interface18_1 := util.TestBuildInterface(t, dbSession, &instance18.ID, &subnet1.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, interface18_1)
	interface18_2 := util.TestBuildInterface(t, dbSession, &instance18.ID, &subnet2.ID, nil, false, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, interface18_2)
	interface18_3 := util.TestBuildInterface(t, dbSession, &instance18.ID, &subnet3.ID, nil, false, &tnu.ID, cdbm.InterfaceStatusPending)
	...
	instanceInventory := &cwsv1.InstanceInventory{
		...
		Instances: []*cwsv1.Instance{
			{
				Id: &cwsv1.UUID{Value: instance1.ID.String()},
				Config: &cwsv1.InstanceConfig{
					Network: &cwsv1.InstanceNetworkConfig{
						Interfaces: []*cwsv1.InstanceInterfaceConfig{
							{
								FunctionType:     cwsv1.InterfaceFunctionType_PHYSICAL_FUNCTION,
								NetworkSegmentId: &cwsv1.UUID{Value: subnet1.ControllerNetworkSegmentID.String()},
							},
							{
								FunctionType:     cwsv1.InterfaceFunctionType_VIRTUAL_FUNCTION,
								NetworkSegmentId: &cwsv1.UUID{Value: subnet2.ControllerNetworkSegmentID.String()},
							},
						},
					},
						...
						IbInterfaces: []*cwsv1.InstanceIBInterfaceConfig{
							{
								...
								DeviceInstance: 0,
								FunctionType:   cwsv1.InterfaceFunctionType_PHYSICAL_FUNCTION,
								IbPartitionId:  &cwsv1.UUID{Value: partition1.ControllerIBPartitionID.String()},
							},
							{
								Device:         "MT2910 Family [ConnectX-7]",
								Vendor:         cdb.GetStrPtr("Mellanox Technologies"),
			...
			{
				Id:     &cwsv1.UUID{Value: instance5.ControllerInstanceID.String()},
				Config: &cwsv1.InstanceConfig{},
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
						State: cwsv1.TenantState_READY,
			...
			{
				Id:     &cwsv1.UUID{Value: instance6.ControllerInstanceID.String()},
				Config: &cwsv1.InstanceConfig{},
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
						State: cwsv1.TenantState_READY,
			...
			{
				Id:     &cwsv1.UUID{Value: instance7.ID.String()},
				Config: &cwsv1.InstanceConfig{},
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
						State: cwsv1.TenantState_READY,
			...
			{
				Id:     &cwsv1.UUID{Value: instance9.ID.String()},
				Config: &cwsv1.InstanceConfig{},
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
						State: cwsv1.TenantState_READY,
			...
			{
				Id: &cwsv1.UUID{Value: instance11.ControllerInstanceID.String()},
				Config: &cwsv1.InstanceConfig{
					Network: &cwsv1.InstanceNetworkConfig{
						Interfaces: []*cwsv1.InstanceInterfaceConfig{
							{
			...
			{
				Id: &cwsv1.UUID{Value: instance15.ControllerInstanceID.String()},
				Config: &cwsv1.InstanceConfig{
					Network: &cwsv1.InstanceNetworkConfig{
						Interfaces: []*cwsv1.InstanceInterfaceConfig{
							{
								...
								// VPC Prefix info
								NetworkDetails: &cwsv1.InstanceInterfaceConfig_VpcPrefixId{
									VpcPrefixId: &cwsv1.UUID{Value: vpcPrefix2.ID.String()},
								},
							},
						},
					},
			...
			{
				Id:     &cwsv1.UUID{Value: instance13.ID.String()},
				Config: &cwsv1.InstanceConfig{},
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
			...
			{
				Id:     &cwsv1.UUID{Value: instance14.ID.String()},
				Config: &cwsv1.InstanceConfig{},
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
						State: cwsv1.TenantState_READY,
			...
			{
				Id:               &cwsv1.UUID{Value: instance16.ControllerInstanceID.String()},
				Config:           &cwsv1.InstanceConfig{},
			...
			{
				Id:               &cwsv1.UUID{Value: instance17.ControllerInstanceID.String()},
				Config:           &cwsv1.InstanceConfig{},
				TpmEkCertificate: &tpmEKCertBase64,
				Status: &cwsv1.InstanceStatus{
					Tenant: &cwsv1.InstanceTenantStatus{
			...
			{
				Id: &cwsv1.UUID{Value: instance18.ID.String()},
				Config: &cwsv1.InstanceConfig{
					Network: &cwsv1.InstanceNetworkConfig{
						Interfaces: []*cwsv1.InstanceInterfaceConfig{
							{
	...
	for i := 0; i < 34; i++ {
		ctrlIns := &cwsv1.Instance{
			Id:     &cwsv1.UUID{Value: pagedInvIds[i]},
			Config: &cwsv1.InstanceConfig{},
			Status: &cwsv1.InstanceStatus{
				Tenant: &cwsv1.InstanceTenantStatus{
					State: cwsv1.TenantState_READY,
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.updatedVpcPrefixInstance != nil {
				...
				assert.Nil(t, err)
				assert.Equal(t, 1, totalIfcs)

				ifcvpc, err := ifcDAO.GetByID(ctx, nil, ifcvpc.ID, nil)
				assert.Nil(t, err)
...
func TestManageInstance_RebootInstanceViaSiteAgent(t *testing.T) {
	...
	assert.Nil(t, err)
	ifc := util.TestBuildInterface(t, dbSession, &instance1.ID, &subnet.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifc)
...
func TestManageInstance_UpdateRebootInstanceInDB(t *testing.T) {
	...
	ifc2 := util.TestBuildInterface(t, dbSession, &instance.ID, &subnet.ID, nil, true, &tnu.ID, cdbm.InterfaceStatusPending)
	assert.NotNil(t, ifc2)
...
func Test_InstanceMetrics_Create_PendingToReady(t *testing.T) {
	...
	util.TestAssertMetricExistsTimes(t, reg, "cloud_workflow_instance_operation_duration_seconds", 1, map[string]string{
...
func Test_InstanceMetrics_Create_ReadyErrorReady(t *testing.T) {
	...
	util.TestAssertMetricExistsTimes(t, reg, "cloud_workflow_instance_operation_duration_seconds", 0, nil, 0)
}
