...
func main() {
	...
	if tcfg.Namespace == cwfn.CloudNamespace {
		...
		w.RegisterWorkflow(vpcWorkflow.RecordVpcLifecycleMetrics)

		// Subnet workflows
		w.RegisterWorkflow(subnetWorkflow.UpdateSubnetInfo)
		w.RegisterWorkflow(subnetWorkflow.UpdateSubnetInventory)
		w.RegisterWorkflow(subnetWorkflow.RecordSubnetLifecycleMetrics)
		...
		w.RegisterWorkflow(instanceWorkflow.RecordInstanceLifecycleMetrics)
