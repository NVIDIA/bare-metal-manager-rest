...
// NOTED: Edited from PowerState to ComputerSystemPowerState to avoid conflict with forge.proto definition
...
const file_site_explorer_carbide_proto_rawDesc = "" +
	"\n" +
	"\x1bsite_explorer_carbide.proto\x12\rsite_explorer\x1a\x1egoogle/protobuf/duration.proto\"\xd7\x05\n" +
	...
	"\x12secure_boot_status\x18\x11 \x01(\v2\x1f.site_explorer.SecureBootStatusR\x10secureBootStatusB\x19\n" +
	...
	"\x17last_redfish_powercycle\x18\t \x01(\tR\x15lastRedfishPowercycle\"p\n" +
	...
	"\n" +
	"is_enabled\x18\x01 \x01(\bR\tisEnabled*\x1b\n" +
	"\aNicMode\x12\a\n" +
...
var file_site_explorer_carbide_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_site_explorer_carbide_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_site_explorer_carbide_proto_goTypes = []any{
	...
	(*EndpointExplorationReport)(nil),        // 2: site_explorer.EndpointExplorationReport
	(*ExploredEndpoint)(nil),                 // 3: site_explorer.ExploredEndpoint
	(*ExploredDpu)(nil),                      // 4: site_explorer.ExploredDpu
	(*ExploredManagedHost)(nil),              // 5: site_explorer.ExploredManagedHost
	(*SiteExplorationReport)(nil),            // 6: site_explorer.SiteExplorationReport
	(*ExploredEndpointSearchFilter)(nil),     // 7: site_explorer.ExploredEndpointSearchFilter
	(*ExploredEndpointIdList)(nil),           // 8: site_explorer.ExploredEndpointIdList
	(*ExploredEndpointsByIdsRequest)(nil),    // 9: site_explorer.ExploredEndpointsByIdsRequest
	(*ExploredEndpointList)(nil),             // 10: site_explorer.ExploredEndpointList
	(*ExploredManagedHostSearchFilter)(nil),  // 11: site_explorer.ExploredManagedHostSearchFilter
	(*ExploredManagedHostIdList)(nil),        // 12: site_explorer.ExploredManagedHostIdList
	(*ExploredManagedHostsByIdsRequest)(nil), // 13: site_explorer.ExploredManagedHostsByIdsRequest
	(*ExploredManagedHostList)(nil),          // 14: site_explorer.ExploredManagedHostList
	(*ComputerSystemAttributes)(nil),         // 15: site_explorer.ComputerSystemAttributes
	(*ComputerSystem)(nil),                   // 16: site_explorer.ComputerSystem
	(*Manager)(nil),                          // 17: site_explorer.Manager
	(*EthernetInterface)(nil),                // 18: site_explorer.EthernetInterface
	(*Chassis)(nil),                          // 19: site_explorer.Chassis
	(*NetworkAdapter)(nil),                   // 20: site_explorer.NetworkAdapter
	(*Service)(nil),                          // 21: site_explorer.Service
	(*Inventory)(nil),                        // 22: site_explorer.Inventory
	(*ForgeSetupStatus)(nil),                 // 23: site_explorer.ForgeSetupStatus
	(*ForgeSetupDiff)(nil),                   // 24: site_explorer.ForgeSetupDiff
	(*PCIeDevice)(nil),                       // 25: site_explorer.PCIeDevice
	(*SystemStatus)(nil),                     // 26: site_explorer.SystemStatus
	(*BootOrder)(nil),                        // 27: site_explorer.BootOrder
	(*BootOption)(nil),                       // 28: site_explorer.BootOption
	(*SecureBootStatus)(nil),                 // 29: site_explorer.SecureBootStatus
	(*durationpb.Duration)(nil),              // 30: google.protobuf.Duration
}
var file_site_explorer_carbide_proto_depIdxs = []int32{
	30, // 0: site_explorer.EndpointExplorationReport.last_exploration_latency:type_name -> google.protobuf.Duration
	17, // 1: site_explorer.EndpointExplorationReport.managers:type_name -> site_explorer.Manager
	16, // 2: site_explorer.EndpointExplorationReport.systems:type_name -> site_explorer.ComputerSystem
	19, // 3: site_explorer.EndpointExplorationReport.chassis:type_name -> site_explorer.Chassis
	21, // 4: site_explorer.EndpointExplorationReport.service:type_name -> site_explorer.Service
	23, // 5: site_explorer.EndpointExplorationReport.forge_setup_status:type_name -> site_explorer.ForgeSetupStatus
	29, // 6: site_explorer.EndpointExplorationReport.secure_boot_status:type_name -> site_explorer.SecureBootStatus
	2,  // 7: site_explorer.ExploredEndpoint.report:type_name -> site_explorer.EndpointExplorationReport
	4,  // 8: site_explorer.ExploredManagedHost.dpus:type_name -> site_explorer.ExploredDpu
	3,  // 9: site_explorer.SiteExplorationReport.endpoints:type_name -> site_explorer.ExploredEndpoint
	5,  // 10: site_explorer.SiteExplorationReport.managed_hosts:type_name -> site_explorer.ExploredManagedHost
	3,  // 11: site_explorer.ExploredEndpointList.endpoints:type_name -> site_explorer.ExploredEndpoint
	5,  // 12: site_explorer.ExploredManagedHostList.managed_hosts:type_name -> site_explorer.ExploredManagedHost
	0,  // 13: site_explorer.ComputerSystemAttributes.nic_mode:type_name -> site_explorer.NicMode
	15, // 14: site_explorer.ComputerSystem.attributes:type_name -> site_explorer.ComputerSystemAttributes
	18, // 15: site_explorer.ComputerSystem.ethernet_interfaces:type_name -> site_explorer.EthernetInterface
	25, // 16: site_explorer.ComputerSystem.pcie_devices:type_name -> site_explorer.PCIeDevice
	1,  // 17: site_explorer.ComputerSystem.power_state:type_name -> site_explorer.ComputerSystemPowerState
	27, // 18: site_explorer.ComputerSystem.boot_order:type_name -> site_explorer.BootOrder
	18, // 19: site_explorer.Manager.ethernet_interfaces:type_name -> site_explorer.EthernetInterface
	20, // 20: site_explorer.Chassis.network_adapters:type_name -> site_explorer.NetworkAdapter
	22, // 21: site_explorer.Service.inventories:type_name -> site_explorer.Inventory
	24, // 22: site_explorer.ForgeSetupStatus.diffs:type_name -> site_explorer.ForgeSetupDiff
	26, // 23: site_explorer.PCIeDevice.status:type_name -> site_explorer.SystemStatus
	28, // 24: site_explorer.BootOrder.boot_order:type_name -> site_explorer.BootOption
