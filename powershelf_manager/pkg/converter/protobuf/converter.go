...
import (
	"fmt"
	pb "github.com/nvidia/bare-metal-manager-rest/powershelf_manager/internal/proto/v1"
	...
	"github.com/nvidia/bare-metal-manager-rest/powershelf_manager/pkg/objects/powersupply"
