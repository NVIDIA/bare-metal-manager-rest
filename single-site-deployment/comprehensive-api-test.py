...
Tests all major API endpoints defined in the OpenAPI specification
"""
...
def update_site_agent_environment(site_uuid):
    """Update the site-agent StatefulSet with the correct site UUID in environment variables"""
    # Patch the statefulset to update CLUSTER_ID and TEMPORAL_SUBSCRIBE_NAMESPACE
    patch = {
        "spec": {
            "template": {
                "spec": {
                    "containers": [{
                        "name": "carbide-site-agent",
                        "env": [
                            {"name": "CLUSTER_ID", "value": site_uuid},
                            {"name": "TEMPORAL_SUBSCRIBE_NAMESPACE", "value": f"site-{site_uuid}"}
                        ]
                    }]
                }
            }
    ...
    cmd = ["kubectl", "patch", "statefulset", "carbide-site-agent", "-n", "carbide-site",
           "--type=strategic", "--patch", json.dumps(patch)]
    success, stdout, stderr = run_command(cmd, check=False)
    
    if not success:
        print_error(f"Failed to patch StatefulSet: {stderr}")
        return False
...
def perform_site_registration(site_uuid):
    ...
    print_header("Site Registration Process")
    print_info(f"Registering site: {site_uuid}")
    
    if not ctx.site_registration_token:
        print_error("No registration token available")
        return False
    
    print_info("Step 1: Getting CA certificate...")
    ca_cert = get_ca_cert()
    if not ca_cert:
    ...
    print_info("Step 2: Updating site-agent bootstrap ConfigMap...")
    ...
    print_info("Step 3: Updating site-agent environment variables...")
    if not update_site_agent_environment(site_uuid):
        print_error("Failed to update site-agent environment")
        return False
    print_success("StatefulSet patched with site UUID")
    
    print_info("Step 4: Restarting site-agent...")
    if not restart_site_agent():
        print_warning("Site-agent restart had issues, continuing...")
    else:
        print_success("Site-agent restarted")
    
    print_info("Step 5: Waiting for bootstrap handshake...")
    if not wait_for_handshake(site_uuid):
        print_warning("Handshake monitoring timed out, continuing...")
    else:
        print_success("Handshake completed")
    
    print_info("Step 6: Calling registration endpoint...")
    ...
    time.sleep(2)
    print_success(f"Site {site_uuid} registration process completed!")
    return True
...
def test_metadata():
    ...
    if success and "version" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Metadata API")
        return False
...
def test_user_current():
    ...
    if success and "email" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Get Current User")
        return False
...
def test_infrastructure_provider():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Infrastructure Provider - Get Current")
        return False
...
def test_infrastructure_provider_stats():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Infrastructure Provider Stats")
        return False
...
def test_site_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Site - Create")
        return False
...
def test_site_get():
    ...
    if success and data.get("id") == ctx.site_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Site - Get by ID")
        return False
...
def test_site_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Site - List All")
        return False
...
def test_site_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Site - Update")
        return False
...
def test_site_status_history():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Site - Status History")
        return False
...
def test_ip_block_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("IP Block - Create")
        return False
...
def test_ip_block_get():
    ...
    if success and data.get("id") == ctx.ip_block_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("IP Block - Get by ID")
        return False
...
def test_ip_block_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("IP Block - List All")
        return False
...
def test_ip_block_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("IP Block - Update")
        return False
...
def test_instance_type_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Instance Type - Create")
        return False
...
def test_instance_type_get():
    ...
    if success and data.get("id") == ctx.instance_type_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Instance Type - Get by ID")
        return False
...
def test_instance_type_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Instance Type - List All")
        return False
...
def test_instance_type_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Instance Type - Update")
        return False
...
def test_machine_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Machine - List All")
        return False
...
def test_machine_get():
    ...
    if success and data.get("id") == ctx.machine_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Machine - Get by ID")
        return False
...
def test_machine_capabilities():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Machine Capabilities - List All")
        return False
...
def test_expected_machine_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Expected Machine - Create")
        return False
...
def test_expected_machine_get():
    ...
    if success and data.get("id") == ctx.expected_machine_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Expected Machine - Get by ID")
        return False
...
def test_expected_machine_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Expected Machine - List All")
        return False
...
def test_expected_machine_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Expected Machine - Update")
        return False
...
def test_tenant_stats():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Tenant - Get Stats")
        return False
...
def test_tenant_account_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Tenant Account - List All")
        return False
...
def test_allocation_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Allocation - Create")
        return False
...
def test_allocation_get():
    ...
    if success and data.get("id") == ctx.allocation_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Allocation - Get by ID")
        return False
...
def test_allocation_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Allocation - List All")
        return False
...
def test_allocation_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Allocation - Update")
        return False
...
def test_allocation_constraint_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Allocation Constraint - List All")
        return False
...
def test_vpc_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC - Create")
        return False
...
def test_vpc_get():
    ...
    if success and data.get("id") == ctx.vpc_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC - Get by ID")
        return False
...
def test_vpc_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC - List All")
        return False
...
def test_vpc_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC - Update")
        return False
...
def test_vpc_prefix_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC Prefix - Create")
        return False
...
def test_vpc_prefix_get():
    ...
    if success and data.get("id") == ctx.vpc_prefix_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC Prefix - Get by ID")
        return False
...
def test_vpc_prefix_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC Prefix - List All")
        return False
...
def test_subnet_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Subnet - Create")
        return False
...
def test_subnet_get():
    ...
    if success and data.get("id") == ctx.subnet_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Subnet - Get by ID")
        return False
...
def test_subnet_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Subnet - List All")
        return False
...
def test_subnet_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Subnet - Update")
        return False
...
def test_operating_system_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Operating System - Create")
        return False
...
def test_operating_system_get():
    ...
    if success and data.get("id") == ctx.operating_system_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Operating System - Get by ID")
        return False
...
def test_operating_system_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Operating System - List All")
        return False
...
def test_operating_system_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Operating System - Update")
        return False
...
def test_ssh_key_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key - Create")
        return False
...
def test_ssh_key_get():
    ...
    if success and data.get("id") == ctx.ssh_key_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key - Get by ID")
        return False
...
def test_ssh_key_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key - List All")
        return False
...
def test_ssh_key_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key - Update")
        return False
...
def test_ssh_key_group_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key Group - Create")
        return False
...
def test_ssh_key_group_get():
    ...
    if success and data.get("id") == ctx.ssh_key_group_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key Group - Get by ID")
        return False
...
def test_ssh_key_group_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key Group - List All")
        return False
...
def test_infiniband_partition_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("InfiniBand Partition - Create")
        return False
...
def test_infiniband_partition_get():
    ...
    if success and data.get("id") == ctx.infiniband_partition_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("InfiniBand Partition - Get by ID")
        return False
...
def test_infiniband_partition_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("InfiniBand Partition - List All")
        return False
...
def test_infiniband_partition_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("InfiniBand Partition - Update")
        return False
...
def test_network_security_group_create():
    ...
    if success and "id" in data:
        ...
        stats.failed += 1
        stats.failed_tests.append("Network Security Group - Create")
        return False
...
def test_network_security_group_get():
    ...
    if success and data.get("id") == ctx.network_security_group_id:
        ...
        stats.failed += 1
        stats.failed_tests.append("Network Security Group - Get by ID")
        return False
...
def test_network_security_group_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Network Security Group - List All")
        return False
...
def test_network_security_group_update():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Network Security Group - Update")
        return False
...
def test_audit_list():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Audit - List Entries")
        return False
...
def test_network_security_group_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Network Security Group - Delete")
        return False
...
def test_infiniband_partition_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("InfiniBand Partition - Delete")
        return False
...
def test_ssh_key_group_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key Group - Delete")
        return False
...
def test_ssh_key_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("SSH Key - Delete")
        return False
...
def test_operating_system_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Operating System - Delete")
        return False
...
def test_subnet_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Subnet - Delete")
        return False
...
def test_vpc_prefix_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC Prefix - Delete")
        return False
...
def test_vpc_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("VPC - Delete")
        return False
...
def test_allocation_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Allocation - Delete")
        return False
...
def test_expected_machine_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Expected Machine - Delete")
        return False
...
def test_instance_type_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Instance Type - Delete")
        return False
...
def test_ip_block_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("IP Block - Delete")
        return False
...
def test_site_delete():
    ...
    if success:
        ...
        stats.failed += 1
        stats.failed_tests.append("Site - Delete")
        return False
...
def run_site_tests(register_site=False):
    """Run all Site tests"""
    print_header("Site Tests")
    test_site_create()
    
    if register_site and ctx.site_id:
        if perform_site_registration(ctx.site_id):
            print_success("Site registration completed successfully")
        else:
            print_warning("Site registration had issues, continuing with tests")
...
Examples:
  # Run all tests
  ./comprehensive-api-test.py

  # Skip port-forward setup (if already running)
  ./comprehensive-api-test.py --skip-setup
        """
    )
    parser.add_argument(
        "--skip-setup",
    ...
    parser.add_argument(
        "--register-site",
        action="store_true",
        help="Register the site after creation (enables full workflow testing)"
    )
    ...
    try:
        ...
        run_site_tests(register_site=args.register_site)
        run_ip_block_tests()
