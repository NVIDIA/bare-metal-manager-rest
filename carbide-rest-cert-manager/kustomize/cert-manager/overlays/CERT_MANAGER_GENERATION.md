...
This downloads the cert-manager v1.9.1 manifests from the [official GitHub release](https://github.com/cert-manager/cert-manager/releases/tag/v1.9.1) and places them in the overlay directories.

## Manual Generation

```bash
curl -fsSL https://github.com/cert-manager/cert-manager/releases/download/v1.9.1/cert-manager.yaml \
  -o kustomize/cert-manager/overlays/local/cert-manager.yaml
```
