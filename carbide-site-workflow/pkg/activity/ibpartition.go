...
func (mmi *ManageInfiniBandPartitionInventory) DiscoverInfiniBandPartitionInventory(ctx context.Context) error {
	...
	inventoryImpl := manageInventoryImpl[*cwssaws.UUID, *cwssaws.IBPartition, *cwssaws.InfiniBandPartitionInventory]{
...
func ibpFindIDs(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, error) {
...
func ibpFindByIDs(ctx context.Context, carbideClient *cClient.CarbideClient, ids []*cwssaws.UUID) ([]*cwssaws.IBPartition, error) {
...
func ibpPagedInventory(allItemIDs []*cwssaws.UUID, pagedItems []*cwssaws.IBPartition, input *pagedInventoryInput) *cwssaws.InfiniBandPartitionInventory {
	itemIDs := []string{}
...
func ibpFindFallback(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, []*cwssaws.IBPartition, error) {
