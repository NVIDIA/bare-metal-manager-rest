...
func (mvi *ManageVpcPeeringInventory) DiscoverVpcPeeringInventory(ctx context.Context) error {
	...
	inventoryImpl := manageInventoryImpl[*cwssaws.UUID, *cwssaws.VpcPeering, *cwssaws.VPCPeeringInventory]{
		itemType:               "VpcPeering",
		config:                 mvi.config,
...
func VpcPeeringFindIDs(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, error) {
...
func VpcPeeringFindByIDs(ctx context.Context, carbideClient *cClient.CarbideClient, ids []*cwssaws.UUID) ([]*cwssaws.VpcPeering, error) {
...
func VpcPeeringPagedInventory(allItemIDs []*cwssaws.UUID, pagedItems []*cwssaws.VpcPeering, input *pagedInventoryInput) *cwssaws.VPCPeeringInventory {
