...
func (mmi *ManageInstanceInventory) DiscoverInstanceInventory(ctx context.Context) error {
	...
	logger.Info().Msg("Starting activity")
	inventoryImpl := manageInventoryImpl[*cwssaws.UUID, *cwssaws.Instance, *cwssaws.InstanceInventory]{
		itemType:                          "Instance",
		config:                            mmi.config,
...
func instanceFindIDs(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, error) {
...
func instanceFindByIDs(ctx context.Context, carbideClient *cClient.CarbideClient, ids []*cwssaws.UUID) ([]*cwssaws.Instance, error) {
...
func instancePagedInventory(allItemIDs []*cwssaws.UUID, pagedItems []*cwssaws.Instance, input *pagedInventoryInput) *cwssaws.InstanceInventory {
	itemIDs := []string{}
