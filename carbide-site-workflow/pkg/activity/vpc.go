...
func (mvi *ManageVPCInventory) DiscoverVPCInventory(ctx context.Context) error {
	...
	inventoryImpl := manageInventoryImpl[*cwssaws.UUID, *cwssaws.Vpc, *cwssaws.VPCInventory]{
		itemType:                          "Vpc",
		config:                            mvi.config,
...
func vpcFindIDs(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, error) {
...
func vpcFindByIDs(ctx context.Context, carbideClient *cClient.CarbideClient, ids []*cwssaws.UUID) ([]*cwssaws.Vpc, error) {
...
func vpcPagedInventory(allItemIDs []*cwssaws.UUID, pagedItems []*cwssaws.Vpc, input *pagedInventoryInput) *cwssaws.VPCInventory {
	itemIDs := []string{}
