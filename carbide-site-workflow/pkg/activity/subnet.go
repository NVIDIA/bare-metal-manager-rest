...
func (mmi *ManageSubnetInventory) DiscoverSubnetInventory(ctx context.Context) error {
	...
	logger.Info().Msg("Starting activity")
	inventoryImpl := manageInventoryImpl[*cwssaws.UUID, *cwssaws.NetworkSegment, *cwssaws.SubnetInventory]{
		itemType:               "Subnet",
		config:                 mmi.config,
...
func subnetFindIDs(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, error) {
...
func subnetFindByIDs(ctx context.Context, carbideClient *cClient.CarbideClient, ids []*cwssaws.UUID) ([]*cwssaws.NetworkSegment, error) {
...
func subnetPagedInventory(allItemIDs []*cwssaws.UUID, pagedItems []*cwssaws.NetworkSegment, input *pagedInventoryInput) *cwssaws.SubnetInventory {
	itemIDs := []string{}
...
func subnetFindFallback(ctx context.Context, carbideClient *cClient.CarbideClient) ([]*cwssaws.UUID, []*cwssaws.NetworkSegment, error) {
