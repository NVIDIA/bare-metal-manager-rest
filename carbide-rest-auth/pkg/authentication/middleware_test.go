...
import (
	...
	config2 "github.com/NVIDIA/carbide-rest-api/carbide-rest-auth/pkg/config"
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-auth/pkg/core/claim"
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-auth/pkg/processors"
	"github.com/NVIDIA/carbide-rest-api/carbide-rest-common/pkg/config"
...
const (
	ssaIssuer      = "https://test-ssa-issuer.example.com"
	kasIssuer      = "test-kas-issuer.example.com"
...
func TestAuthProcessor(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "test auth processor error, path not found",
			args: args{
				ds:           dbSession,
				joCfg:        joCfg,
				tc:           tc,
				path:         "/v2/org/testorg/badpath",
				pathOverride: cdb.GetStrPtr(EchoUnmatchedPath),
				org:          "testorg",
			},
			wantErrMsg:   "The requested path could not be found",
